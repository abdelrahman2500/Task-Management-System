...
- generic [ref=f1e4]:
  - generic [ref=f1e8]:
    ...
    - generic [ref=f1e11]:
      ...
      - generic [ref=f1e19]: Team Collaboration
      - generic [ref=f1e26]: Smart Task Tracking
    - generic [ref=f1e31]:
      - generic [ref=f1e32]:
        - heading "500+" [level=2] [ref=f1e33]
        - paragraph [ref=f1e34]: Projects
      - generic [ref=f1e35]:
        - heading "1200+" [level=2] [ref=f1e36]
        - paragraph [ref=f1e37]: Tasks
  - generic [ref=f1e40]:
    - generic [ref=f1e41]:
      - heading "Welcome Back 👋" [level=2] [ref=f1e42]
      - paragraph [ref=f1e43]: Sign in to continue managing your projects.
    - generic [ref=f1e44]:
      - generic [ref=f1e45]: Email
      - textbox "Email" [ref=f1e51]:
        - /placeholder: john@example.com
    - generic [ref=f1e52]:
      - generic [ref=f1e53]: Password
      - generic [ref=f1e54]:
        - textbox "Password" [ref=f1e59]:
          - /placeholder: ••••••••
        - button [ref=f1e60]
    - generic [ref=f1e64]:
      - generic [ref=f1e65]:
        - checkbox "Remember me" [ref=f1e66]
        - text: Remember me
      - link "Forgot password?" [ref=f1e67] [cursor=pointer]:
        - /url: "#"
    - button "Sign In" [ref=f1e68]
    - paragraph [ref=f1e70]:
      - text: Don't have an account?
      - button "Sign Up" [ref=f1e71]
```
