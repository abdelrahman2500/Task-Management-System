...
- Name: api-resilience.spec.ts >> API Resilience >> should handle 403 forbidden errors
- Location: e2e\tests\api-resilience.spec.ts:53:3

# Error details

```
Error: Failed to create project: {"success":false,"error":{"code":"VALIDATION_FAILED","message":"The request contains invalid input parameters.","details":{"":"Unrecognized key(s) in object: 'status'"},"requestId":"5272a01f-835a-41d9-8051-335cdc574113"}}
```
