...
- Name: api-resilience.spec.ts >> API Resilience >> should handle 422 validation errors from API
- Location: e2e\tests\api-resilience.spec.ts:17:3
...
```ts
  1   | /**
  2   |  * API Resilience E2E Tests
  3   |  *
  4   |  * Covers:
  5   |  * - API error handling (4xx, 5xx errors)
  6   |  * - Retry behavior
