...
Locator: locator('text=An account with this email already exists')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=An account with this email already exists')
...
- paragraph: Join us to start managing your projects.
- text: Full Name
- textbox "Full Name":
...
- textbox "Email":
  ...
  - text: test-1786868257857_vnqbnr_signup_duplicate@example.com
- text: Password
- textbox "Password":
  - /placeholder: ••••••••
